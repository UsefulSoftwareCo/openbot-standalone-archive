...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.openbotChannelsList]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotChannelsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotChannelsCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChannelUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChannelDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChannelSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotContextGet]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotContextUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChannelSend]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChannelRespond]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChannelSnooze]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChannelWake]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChannelCancel]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChannelSetModel]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotThreadStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotProjectsList]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotProjectsSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotProjectsCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotProjectGet]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotProjectUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotProjectDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotKnowledgeList]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotKnowledgeSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotKnowledgeGet]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotKnowledgeCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotKnowledgeUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotKnowledgeDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotComputerStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotComputerSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotComputerSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotComputerWindowsList]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotComputerWindowFocus]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotComputerDisplayCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotComputerDisplayDestroy]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotComputerInput]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotComputerControl]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotComputerLaunch]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChatComputerGet]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotChatComputerEnsure]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChatComputerSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotChatComputerSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.openbotChatComputerWindowFocus]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChatComputerLaunch]: AuthOrchestrationOperateScope,
  [WS_METHODS.openbotChatComputerInput]: AuthOrchestrationOperateScope,
