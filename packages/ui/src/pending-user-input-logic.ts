...
/**
 * A structured question a provider is waiting on. Every client's pending
 * request shape (thread projections in T3 web, channel views in OpenBot)
 * narrows to this, so the draft-answer logic below is shared verbatim.
 */
export type PendingUserInputQuestion = OrchestrationV2UserInputQuestion;
