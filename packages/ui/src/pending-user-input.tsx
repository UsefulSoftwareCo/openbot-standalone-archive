...
import { Collapsible, CollapsiblePanel, CollapsibleTrigger } from "./collapsible.tsx";
import { ComposerBanner } from "./composer-banner.tsx";
import {
  derivePendingUserInputProgress,
  type PendingUserInputDraftAnswer,
  type PendingUserInputQuestion,
} from "./pending-user-input-logic.ts";

/**
 * The structured prompt a provider is waiting on. Clients pass their own
 * pending-request record; only these fields are read, so a thread projection
 * and an OpenBot channel view both fit without conversion.
 */
...
interface PendingUserInputPanelProps {
  pendingUserInputs: ReadonlyArray<PendingUserInputPrompt>;
  respondingRequestIds: ReadonlyArray<RuntimeRequestId>;
...
export const PendingUserInputCard = memo(function PendingUserInputCard({
  prompt,
  isResponding,
  answers,
  questionIndex,
